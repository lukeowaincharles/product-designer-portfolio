                      ...
                      >
                        {(progress, event) => {
                          return (
                            ...
                            >
                              <svg className="hero__highlight hero__highlight--bottom-30" id="iamHighlight" width="400" height="23" viewBox="0 0 400 23" fill="none" xmlns="http://www.w3.org/2000/svg">
